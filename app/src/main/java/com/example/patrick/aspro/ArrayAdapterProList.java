...
public class ArrayAdapterProList extends android.widget.ArrayAdapter<User_pro>{

    private final Context context;
    private final ArrayList<User_pro> elements;

    public ArrayAdapterProList(@NonNull Context context, ArrayList<User_pro> elements) {
